...
function plugin.config()
  ...
  vim.keymap.set("n", "zc", "<cmd>Telekasten show_backlinks<cr>", { desc = "Show backlinks to current note" })
  vim.keymap.set("n", "zs", "<cmd>Telekasten show_tags<cr>", { desc = "Search for tags" })
end
